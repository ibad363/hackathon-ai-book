---
id: 0001
title: Set Up Constitution for Hackathon Textbook
stage: constitution
date: 2025-12-06
surface: agent
model: gemini-pro
...
/sp.constitution Constitution for Hackathon I: Physical AI & Humanoid Robotics Textbook Project
...
Must support AI-native learning (Panaversity standard)
...
I have updated the project constitution to version 1.0.0 and propagated the changes to the relevant templates. The constitution is now based on the principles for the Physical AI & Humanoid Robotics Textbook Project. I have also updated the plan, spec, and task templates to align with the new Docusaurus-based structure.
